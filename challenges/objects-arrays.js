...
zooAnimals.forEach(function(element){
  displayNames[i]= `Name: ${element.animal_name}, Scientific: ${element.scientific_name}.`;
  i++;
});
...
*/
const populationTotal = zooAnimals.reduce((sum,element) => sum+element.population, 0);
